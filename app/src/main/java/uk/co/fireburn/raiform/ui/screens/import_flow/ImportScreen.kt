                ...
                if (state.parsedSessions.size == 1) {
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                "Single Routine Detected",
                                fontWeight = FontWeight.Bold,
                                color = MaterialTheme.colorScheme.onTertiaryContainer
                            )
                            Text(
                                "How many times a week does this client do this session?",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onTertiaryContainer
                            )
                            Spacer(Modifier.height(8.dp))
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                IconButton(onClick = viewModel::decreaseFrequency) {
                                    Icon(
                                ...
                                Text(
                                    text = "${state.sessionFrequency}x",
                                    style = MaterialTheme.typography.titleLarge,
                                    fontWeight = FontWeight.Black,
                                    modifier = Modifier.padding(horizontal = 16.dp),
                                    color = MaterialTheme.colorScheme.onTertiaryContainer
                                )
                                IconButton(onClick = viewModel::increaseFrequency) {
                                    Icon(
                                        Icons.Default.Add,
                                        "Increase",
                                        tint = MaterialTheme.colorScheme.onTertiaryContainer
